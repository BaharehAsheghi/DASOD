...
class Network(nn.Module):
    ...
    def __init__(self, channel=32, imagenet_pretrained=True):
        ...
        # pretrained_dict = torch.load('/content/drive/MyDrive/SINet-V2-main/media/nercms/NERCMS/GepengJi/Medical_Seqmentation/CRANet/models/swin_base_patch4_window12_384_22k.pth')["model"]
        ...
        # self.rfb4_1 = RFB_modified(128, channel)
