...
def res2net50_v1b_26w_4s(pretrained=False, **kwargs):
    ...
    model = Res2Net(Bottle2neck, [3, 4, 6, 3], baseWidth=26, scale=4, **kwargs)
    if pretrained:
        model_state = torch.load('/content/drive/MyDrive/SINet-V2-main/media/nercms/NERCMS/GepengJi/Medical_Seqmentation/CRANet/models/res2net50_v1b_26w_4s-3cf99910.pth')
...
def res2net101_v1b_26w_4s(pretrained=False, **kwargs):
    ...
    model = Res2Net(Bottle2neck, [3, 4, 23, 3], baseWidth=26, scale=4, **kwargs)
    if pretrained:
      model_state = torch.load('/content/drive/MyDrive/SINet-V2-main/media/nercms/NERCMS/GepengJi/Medical_Seqmentation/CRANet/models/res2net101_v1b_26w_4s-0812c246.pth')
      model.load_state_dict(model_state)
        # model.load_state_dict(model_zoo.load_url(model_urls['res2net101_v1b_26w_4s']))
    return model
